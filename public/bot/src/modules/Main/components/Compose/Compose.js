                ...
                <button type="button" onClick={sendMessage}>
                    <svg width="46px" height="34px" viewBox="0 0 46 34" version="1.1" xmlns="http://www.w3.org/2000/svg">
                        <g id="Page-1" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd" stroke-linejoin="round">
                            <g id="Group-209" transform="translate(23.000000, 17.000000) scale(-1, 1) translate(-23.000000, -17.000000) translate(2.000000, 2.000000)" stroke="#67c18e" stroke-width="4">
